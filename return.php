...
<br>
  ...
  <div class="row">
   ...
   <div class="row">
    ...
    <div class="col-75">
      <input type="date" id="day" name="day" placeholder="Your fine day..">
    </div>
  </div>
...
if(isset($_POST['submit']))
{
  ...
  $query="insert into ret values('$b_id','$m_id','$day')";
